 ...
 * 
 * @see com.james.myweb.model.Course
...
public class CourseDAO extends BaseHibernateDAO {
	...
	public Course findById(java.lang.Integer id) {
		...
		try {
			Course instance = (Course) getSession().get("com.james.myweb.model.Course", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Course> findByExample(Course instance) {
		...
		try {
			List<Course> results = (List<Course>) getSession().createCriteria("com.james.myweb.model.Course")
